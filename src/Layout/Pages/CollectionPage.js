...
export default function CollectionPage() {
    ...
    const itemImages= [
        ...
        {id: 7, className: "col-lg-4 col-md-6 col-12 items", class: "item-details-7 item-details"},
        {id: 8, className: "col-lg-4 col-md-6 col-12 items", class: "item-details-8 item-details"},
        {id: 9, className: "col-lg-4 col-md-6 col-12 items", class: "item-details-9 item-details"},
    ]
